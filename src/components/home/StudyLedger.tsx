 ...
 * cartões.
 *
 * Mora dentro da abertura de /minha-trilha, logo abaixo do painel de progresso,
 * e por isso é vidro como ele — uma régua branca opaca cortaria a aura ao meio.
 *
...
export default function StudyLedger({ stats }: StudyLedgerProps) {
  return (
    <Rise delay={180} className="mt-10">
      <dl className="material-thin grid gap-8 rounded-[1.75rem] p-6 sm:grid-cols-3 sm:gap-0 sm:divide-x sm:divide-hairline sm:p-8">
        ...
        <div className="min-w-0 sm:px-10">
