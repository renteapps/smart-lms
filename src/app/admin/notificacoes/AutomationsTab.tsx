      ...
      <div className="editorial-card p-6 max-w-3xl mx-auto space-y-6">
        <div className="flex justify-between items-center border-b border-border/60 pb-4">
          ...
          <button
            ...
            className="text-xs font-semibold text-muted hover:text-foreground px-3 py-1.5 rounded-lg border border-border"
          >
            Cancelar
          </button>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          {/* Settings Group */}
          <div className="space-y-4 p-5 border border-border rounded-2xl bg-background-secondary">
            <h3 className="font-bold text-sm text-foreground flex items-center gap-2">
              <Activity className="size-4 text-accent" /> Regra de Disparo (Trigger)
            </h3>
            ...
            <div>
              ...
              <input
                ...
                className="min-h-11 w-full rounded-xl border border-border bg-surface px-4 text-sm text-foreground placeholder:text-muted focus:border-accent focus:outline-none"
                required
              />
            </div>
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-sm text-foreground">Conteúdo do Disparo</h3>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full resize-none rounded-xl border border-border bg-background-secondary px-4 py-3 text-sm text-foreground placeholder:text-muted focus:border-accent focus:bg-surface focus:outline-none leading-relaxed"
                required
              />
            </div>
          ...
          {channels.includes("email") && (
            <div className="p-5 rounded-2xl border-2 border-accent/20 bg-accent/5 space-y-4 animate-in fade-in duration-150">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full min-h-10 rounded-xl border border-border bg-surface px-3 text-xs text-foreground placeholder:text-muted focus:border-accent focus:outline-none"
                  />
                </div>
          ...
          <div className="flex justify-end gap-3 pt-2">
            <button
              type="button"
              onClick={() => setIsCreating(false)}
              className="px-5 py-2.5 rounded-xl border border-border text-xs font-bold text-foreground hover:bg-background-secondary transition-colors"
            >
              Cancelar
            </button>
            <button
              type="submit"
              className="flex items-center justify-center gap-2 rounded-xl bg-accent px-6 py-2.5 text-xs font-bold text-primary-foreground hover:bg-accent-hover transition-all shadow-sm"
            >
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 bg-accent/10 border border-accent/20 p-5 rounded-2xl">
        <div>
          <h3 className="text-base font-bold text-foreground flex items-center gap-2">
            <Activity className="size-4 text-accent" /> Growth Engine & Réguas de Automação
          </h3>
        ...
        <button
          ...
          className="flex h-10 items-center justify-center gap-2 rounded-xl bg-accent px-4 text-xs font-bold text-primary-foreground hover:bg-accent-hover shrink-0 shadow-sm"
        >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {automations.length === 0 ? (
          <div className="col-span-full py-16 text-center text-muted border-2 border-dashed border-border rounded-2xl space-y-2">
            <MailOpen className="size-8 mx-auto opacity-30 text-muted" />
            <p className="font-semibold text-xs text-foreground">Nenhuma automação criada ainda.</p>
          ...
          automations.map((automation) => (
            <div
              key={automation.id}
              className={`relative rounded-2xl border border-border bg-background-secondary p-5 transition-all hover:border-accent/40 space-y-3 ${
            ...
            >
              ...
              <div className="bg-surface rounded-xl p-3 border border-border/60 space-y-1.5">
                <p className="font-bold text-foreground text-xs">{automation.action_title}</p>
                ...
                <div className="flex gap-1.5 pt-1 flex-wrap">
                  ...
                  {automation.email_details?.template && (
                    <span className="text-[9px] uppercase tracking-wider px-2 py-0.5 rounded-full font-mono bg-accent/10 text-accent">
