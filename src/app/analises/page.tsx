...
import { getAnalyticsOverview, getCoursesAnalytics, getSalesAnalytics, getAgentsAnalytics, getSubscriptionsAnalytics, getStudentsAnalytics } from "@/app/admin/analises/actions";
import { MOCK_ANALYTICS_CARDS } from "@/lib/mocks/analyticsMocks";

export default async function AnalisesHubDirectPage() {
  ...
  return <AnalyticsHubView basePath="/analises" overviewData={overviewData} cardsData={cardsData} />;
}
